...
public class TokenEndpointTest {
	...
	public void getToken() throws Exception {
		...
		final Map<String, Object> expected = MapBuilder.<String, Object>newHashMap()
				...
				.with("mfa", MfaStatus.UNKNOWN.getID())
				.build();
	...
	public void getTokenMfaIsolation() throws Exception {
		...
		assertThat("token1 should have MFA=true", response1.get("mfa"), is(MfaStatus.USED.getID()));
		...
		assertThat("token2 should have MFA=false", response2.get("mfa"), is(MfaStatus.NOT_USED.getID()));
	}
	...
	private void testTokenEndpointReturnsMfaAuthenticatedField(final String userName, final String displayName, 
		...
		assertThat("incorrect MFA status", response.get("mfa"), is(mfaStatus.getID()));
